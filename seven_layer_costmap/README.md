...
three-ZED-X/SVO-ready prototype. Version 0.8 defaults to a perception-only mode:
...
- `/seven_layer_costmap/costmap`: compatibility output from five visual layers;
