...
## Where the CPU actually goes (same session)
...
instead of 15. The tick rate is the smallest of these levers. The big ones are
not running the voxel stack and two RViz instances alongside perception, and
switching the cameras to the lean profile (-39% on the drivers,
`2026-09-16_lean-vs-old-camera-profile.md`).
